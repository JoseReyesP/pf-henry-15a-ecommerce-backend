...
// <body>
//     <div class="container">
//         <h2 style="color: #3498db;">¡Bienvenido a nuestro sitio web!</h2>
...
//         <a class="button" href="https://travelto-front.vercel.app/" style="background-color: #3498db; color: #fff; text-decoration: none; border-radius: 5px; display: inline-block; padding: 10px 20px; margin-top: 20px;">Confirmar Registro</a>

//         <p class="footer" style="margin-top: 20px; font-size: 12px; color: #777;">Si no te registraste en nuestro sitio, por favor ignora este correo.</p>
//     </div>
// </body>
// </html>
// `
